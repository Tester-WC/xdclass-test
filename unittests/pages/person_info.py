...
class PersonalInformation():
    ...
    def phoneNORandomGenerator(self):
        prelist = ["130", "131", "132", "133", "134", "135", "136", "137", "138", "139", "147", "150", "151", "152",
                   "153", "155", "156", "157", "158", "159", "182", "183", "186", "187", "188"]
        return random.choice(prelist) + str(int(time.time()))[-8:]
    ...
    def getBirthday(self):
        ...
        if day < 10:
            day = '0' + str(day)
        g['birthday'] = str(year) + str(month) + str(day)
        timestr = str(year) + '-' + str(month) + '-' + str(day) + ' ' + '00:00:00.000'
        datetime_obj = datetime.strptime(timestr, "%Y-%m-%d %H:%M:%S.%f")
        birthday_stamp = int(time.mktime(datetime_obj.timetuple()) * 1000.0 + datetime_obj.microsecond / 1000.0)
        lst=[g['birthday'], birthday_stamp]
        return lst
...
def PersonalInfo():
    ...
    info['birthday_stamp'] = birthday[1]
    info['idnum'] = PersonalInfo.idnum(info['birthday'][0], info['sex'])
    info['phone'] = PersonalInfo.phoneNORandomGenerator()
    info['emali'] = PersonalInfo.emaliInfo(info['phone'])
    return info


persominfo = PersonalInfo()
